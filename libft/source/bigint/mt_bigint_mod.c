...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/28 13:03:48 by javgonza          #+#    #+#             */
/*   Updated: 2021/01/28 13:06:50 by javgonza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	mt_bigint_mod(struct s_bigint *this, struct s_bigint *div)
{
	...
	while (c_bigint.compare(&remainder, div) >= 0)
	{
		...
		current_bit.shift_right(&current_bit, bit);
		factor.shift_right(&factor, bit);
	}
