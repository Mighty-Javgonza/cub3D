...
/*   Updated: 2022/02/22 15:31:09 by javgonza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void						calculate_segment_segment_collision(
...
float						proportion_between(float low_bound, float up_bound,
								float value);
float						interpolate_float(float max_val, float min_val,
								size_t step_count, size_t step);
int							interpolate_int(int min_val, int max_val,
								size_t step_count, size_t step);
...
float						distance_to_closest_segment_end(t_segment segment,
								t_vector pos);
size_t						*sort_float_array(
								float *values, size_t array_length);
