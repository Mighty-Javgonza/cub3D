...
/*   Updated: 2022/02/21 18:06:18 by javgonza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	render_candidates_closest_to_farthest(t_camera *camera, float *dists_to_candidates, size_t candidate_count)
{
	...
	i = 0;
	while (i < candidate_count && dists_to_candidates[ordered_indices[i]] < DEFAULT_RAY_COLLIDER_LENGTH)
	{
...
void	camera_render_all_candidates(t_camera *camera)
{
	...
	render_candidates_closest_to_farthest(camera, dists_to_candidates, candidate_count);
