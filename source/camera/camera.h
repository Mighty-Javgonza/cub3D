...
/*   Updated: 2022/02/24 12:32:11 by javgonza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			camera_render_pixel(t_camera *cam, t_world *world,
					size_t x_pixel);
t_vector		get_vector_to_plane_from_camera_pixel(t_camera *cam,
					size_t pixel);
...
t_collision		collision_from_camera_pixel(t_camera *cam, t_world *world,
					size_t pixel);
void			camera_render_pixel_group(t_camera *cam, t_world *world,
					size_t start_pixel, size_t group_size);
...
t_collision		collision_from_camera_pixel_with_segment(t_camera *cam,
					size_t pixel, t_segment *segment);
