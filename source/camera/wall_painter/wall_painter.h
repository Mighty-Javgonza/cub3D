...
/*   Updated: 2022/02/24 11:04:57 by javgonza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int							get_column_in_image(t_collision col,
								t_graphic_image *image);
int							get_row_in_image(t_wall_slice_painter slice,
								int paint_offset);
...
t_wall_slice_interpolator	interpolator_from_collisions(t_collision start_col,
								t_collision end_col, t_camera_range range,
								t_camera *cam);
t_wall_slice_painter		calculate_paint_slice(t_camera *cam,
								t_collision col);
t_wall_slice_painter		interpolate_slice(t_wall_slice_painter start_slice,
								t_wall_slice_painter end_slice,
								size_t max_value, size_t value);
void						calculate_slice_z_offset(
								t_wall_slice_painter *slice, t_camera *cam,
								t_collision col);
void						paint_wall_slice(t_camera *cam,
